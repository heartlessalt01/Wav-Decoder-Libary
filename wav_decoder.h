...
/* =========================
   IO Backend (IMPORTANT)
========================= */

typedef struct {
    void* userData;

    /* Must read `bytesToRead` at `offset` into buffer */
...
/* Convenience helper (you should implement in .c if missing) */
